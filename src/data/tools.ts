...
const tools: Tool[] = [
  // === AI TOOLS ===
  {
    ...
    subjects: ["Arabic", "English", "German", "French", "Math", "Science", "ICT", "Religion", "Christianity", "Philosophy", "Montessori", "Social Studies", "Business", "Skills", "Art", "Music", "PE", "Library"],
  ...
  },
  {
    ...
    subjects: ["English", "Math", "Science", "Social Studies", "Music"],
    categories: ["Gamification"],
    type: "edtech",
  },
  {
