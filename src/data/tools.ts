...
const tools: Tool[] = [
  ...
  { id: "thinglink-ss", name: "ThingLink", url: "https://www.thinglink.com/", description: "Immersive learning for real world environments.", descriptionAr: "تعلم غامر للبيئات الواقعية.", subjects: ["Social Studies"], categories: [], type: "edtech" },
